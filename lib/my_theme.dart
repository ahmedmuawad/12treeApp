...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(0, 94, 41, 1.0);
  static Color soft_accent_color = Color.fromRGBO(177, 255, 187, 1.0);
  static Color splash_screen_color = Color.fromRGBO(255, 255, 255, 1.0);
