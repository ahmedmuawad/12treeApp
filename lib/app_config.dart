...
class AppConfig {
  static String copyright_text = "@ Stop4Web " + this_year; //this shows in the splash screen
  static String app_name = "12Tree"; //this shows in the splash screen
  ...
  //configure this
  static const DOMAIN_PATH = "12tree.store";
